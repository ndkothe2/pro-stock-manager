...
class AppController extends BaseController
{
    ...
    public function login(Request $request)
    {
        try {
            ...
            return back()->with('error', 'Authentication service unavailable. Please try again later.');
        }
    }
    ...
    public function generateDummyProductInventoryPdf()
    {
        try {
            ...
            \Log::error("Dummy PDF Generation Error: " . $e->getMessage());
            return back()->with('error', 'Unable to generate Demo PDF report. ' . $e->getMessage());
        }
    }
}